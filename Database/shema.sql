...
INSERT INTO rewards (name, points_required, description, stock, image_url) VALUES 
('Free Espresso', 50, 'A single shot of our premium organic arabica blend.', 100, 'https://images.unsplash.com/photo-1510591509098-f4fdc6d0ff04?q=80&w=400'),
('Digital Gift Card ($10)', 200, 'A digital voucher valid for any online purchase.', 50, 'https://images.unsplash.com/photo-1765559756458-cbb404fce6c2?q=80&w=1172&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
('Premium Coffee Mug', 350, 'Limited edition ceramic mug with a matte finish.', 15, 'https://images.unsplash.com/photo-1516390118834-21602d501886?q=80&w=1536&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
('Stainless Steel Water Bottle', 500, 'Eco-friendly 750ml bottle that keeps drinks cold for 24h.', 25, 'https://images.unsplash.com/photo-1699528136791-9753342316c8?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
('VIP Event Pass', 1500, 'Exclusive access to our annual tasting event.', 5, 'https://images.unsplash.com/photo-1540575861501-7cf05a4b125a?q=80&w=400'),
('Loyalty Tote Bag', 150, '100% recycled cotton shopping bag.', 0, 'https://images.unsplash.com/photo-1667313774260-b6ebccbecad4?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
('Barista Workshop', 3000, 'A 2-hour one-on-one session with our head barista.', 2, 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?q=80&w=400');